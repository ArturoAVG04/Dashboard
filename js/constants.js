...
export const INITIAL_PRODUCTS = [
    ...
    { id: 'h_sup', name: 'Hamburguesas Supers', category: 'Hamburguesas', price: 99 },
...
export const INITIAL_EXPENSE_TAGS = ["Pan", "Carne", "Servilletas", "Refrescos", "Verdura", "Gas", "Desechables", "Limpieza"];
